...
/**
 * _strncmp - a function to compare two strings at n bytes
 * @s1: first string
 * @s2: second string
...
/**
 * _getenv - a function the get the environment variable of a path
 * @name: name of path
 *
 * Return: NULL
 */
...
/******** set environment *********************************/
/**
 * _setenv - a function that set value of an emvironment
 * @name: name of the environment to set
 * @value: value to set
 * @overwrite: a flag indicating whether to overwrite an existing value
 *
...
/******** print environment**********************/
/**
 * printEnvironment - a function that prints the environment of a variable
 *
 *
 * Return: Nothing
 */
